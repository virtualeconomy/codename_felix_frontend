<template>
  <div>
    ...
    <div style="margin:18px 0;color:#ff8737" v-for="(item, index) in $store.state.words" :key="index">{{ item.word.toUpperCase() }}</div>
    <div>Price</div>
    ...
    <div style="margin-top:38px;padding-right:100px">
      ...
      <br /><br />After the word is saved you can also mint it as an NFT.
      <br /><br />Click PAY to continue
    </div>
